...
public class CustomerProductController {
    ...
    public String productDetail(@PathVariable Integer id, HttpSession session, Model model) {
        ...
        // Category/Brand/Material bị Tạm dừng KHÔNG còn ẩn sản phẩm khỏi
        // khách hàng nữa — hàng tồn vẫn phải bán hết được. Việc Tạm dừng
        // chỉ còn tác dụng cảnh báo ở phía admin/staff (xem isMasterDataActive
        // vẫn được dùng trong admin/product/list.html và StaffOrderController).
